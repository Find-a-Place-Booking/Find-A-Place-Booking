export function SearchBar({
  ...
  return (
    <form action="/stays" className={`search-panel ${compact ? "search-compact" : ""}`}>
      <label><span>Where are you headed?</span><input name="where" defaultValue={where} placeholder="Hot Springs, Branson, Lake Ouachita…" aria-label="Destination" autoComplete="off" /></label>
      ...
      <button className="button search-button" type="submit">Find a place <span>→</span></button>
    </form>
  );
}
