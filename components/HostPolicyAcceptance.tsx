...
export function HostPolicyAcceptance({
  ...
  return (
    <section className="panel">
      ...
      <p className="muted">
        This is separate from confirming that you have authority to list the
        property. Before host setup can be completed, the account owner or
        manager must accept the current Find A Place host policies.
      </p>
      ...
      {accepted ? (
        <div className="inline-note">
          ...
          <span>
            {acceptedDate(acceptedAt)
              ...
              : ""}
            A new acceptance will be required when one of these policy versions
            changes.
          </span>
        </div>
      ) : (
        <form action={acceptHostPolicies} className="settings-form">
          ...
          <label className="checkline review-confirm">
            ...
            />
            <span>
              I have read and agree to the current Find A Place Host Agreement,
              Cancellation Policy and Privacy Notice.
            </span>
          </label>
