    ...
    >
      ...
      <div className="dash-grid metrics admin-metrics admin-real-metrics">
        ...
        <Link className="admin-metric-card" href="/admin/content">
          ...
          <strong>Edit</strong>
          <small>Homepage and About copy</small>
        </Link>
      </div>
        ...
        <div className="dash-two">
          ...
          >
            <input
              ...
              placeholder="Host, organization, email or phone…"
            />
          ...
          >
            <input
              ...
              placeholder="Confirmation, guest, property or host…"
            />
            <button className="button button-small" type="submit">
              Search bookings
            </button>
      ...
      <div className="dash-two admin-home-grid">
        <section className="panel">
          <div className="panel-head">
            <div>
              <p className="eyebrow dark">Commission access</p>
              <h2>Partner verification</h2>
            </div>
            {canManagePartners ? (
              <Link href="/admin/partners">Open queue</Link>
            ) : (
              <span className="status-pill status-muted">Role limited</span>
            )}
          </div>
          ...
          {pendingPartners?.length ? (
                ...
                canManagePartners ? (
                  ...
                  >
                    <span>
                      ...
                      <small>
                        {cleanStatus(organization.partner_status)} ·{" "}
                        {cleanStatus(organization.commission_tier)}
                      </small>
                    </span>
                    <b>Review</b>
                  </Link>
            ...
            <div className="panel-empty">
              <strong>No partner requests waiting.</strong>
            </div>
          )}
        </section>
