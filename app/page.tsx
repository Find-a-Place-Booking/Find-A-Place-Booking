    ...
    <>
      <div className="home-hero">
        ...
        <div className="shell hero-layout">
          <div className="hero-copy">
            ...
            <p className="hero-lead">Browse independent cabins, cottages, RV stays and one-of-a-kind places by location, dates and guests. Published stays come directly from approved host listings.</p>
            <div className="hero-proof">
              <span><strong>Search trip details</strong>Location, dates and guests</span>
              <span><strong>Published stays</strong>Real approved host listings</span>
      ...
      <main>
        ...
        <section className="host-cta">
          <div className="shell host-cta-inner"><div><p className="eyebrow">Have a place people should know about?</p><h2>Regional discovery, direct booking and a straightforward commission.</h2></div><div><p>Owners will manage their property, rates, calendar, policies and payouts from one host workspace. Find A Place Booking earns 5% on partner stays or 7% on other host stays, calculated from the nightly lodging subtotal.</p><Link className="button button-light" href="/hosts">See how hosting works →</Link></div></div>
        </section>
      </main>
      <Footer />
    </>
