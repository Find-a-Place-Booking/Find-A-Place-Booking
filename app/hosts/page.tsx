  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="host-preview-section"><div className="shell host-preview-grid"><div className="host-preview-copy"><p className="eyebrow dark">A real operating dashboard</p><h2>Know what is booked, what is open and what needs attention.</h2><p>The host side is built around the day-to-day work of running a short-term rental, with the important information surfaced first and deeper detail available when needed.</p><Link className="under-link" href="/host/sign-in">Open the host portal →</Link></div><div className="host-ui-preview empty-host-preview"><div className="preview-top"><span>Host overview</span><strong>Ready for your first property</strong></div><div className="preview-calendar">{Array.from({length:28},(_,i)=><span key={i}>{i+1}</span>)}</div><div className="preview-booking empty-preview-booking"><div><small>Next step</small><strong>Add a property to begin</strong><span>Bookings and arrivals will appear here automatically.</span></div></div></div></div></section>
